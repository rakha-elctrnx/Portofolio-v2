<template>
  ...
  <div class="max-w-7xl mx-auto flex flex-col relative">
    ...
    <nav class="max-w-7xl px-5 md:fixed top-0 z-[98] w-screen backdrop-blur-md bg-[#f3f3] bg-opacity-80">
  ...
  <footer class="block md:hidden fixed bottom-0 left-0 right-0 rounded-t-3xl border border-[#383838] bg-[#f3f3] bg-opacity-80 backdrop-blur-md backdrop-opacity-90">
